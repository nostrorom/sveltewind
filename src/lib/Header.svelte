...
<header
	class="flex items-center justify-between w-full h-full px-4 py-2 bg-neutral-200 dark:bg-neutral-800"
>
	<div>Svelte</div>
	<nav>
		<ul class="flex h-full space-x-4">
			<li class="h-full hover:text-amber-500">
				<a class="" data-sveltekit-preload-data="hover" href="/">
					<div class="" class:text-emerald-600={$page.url.pathname === '/'}>Home</div>
				</a>
			</li>
			<li class="h-full hover:text-amber-500">
				<a class="" data-sveltekit-preload-data="hover" href="/about">
